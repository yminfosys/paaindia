...
drivernotfoundSchema.plugin(autoIncrement.plugin, { model: 'ukdrivernotfoundcollections', field: 'entryNo',startAt: 1, incrementBy: 1 });
var drivernotfoundmodul = mongoose.model('ukdrivernotfoundcollections', drivernotfoundSchema);
...
var Incentivemodul = mongoose.model('ukincentivecollections', IncentiveSchema);
...
var deliverymodul = mongoose.model('ukdeliverycollections', deliverySchema);
...
branchSchema.plugin(autoIncrement.plugin, { model: 'ukbranchcollections', field: 'branchID',startAt: 1, incrementBy: 1 });
var branchmodul = mongoose.model('ukbranchcollections', branchSchema);
...
adminSchema.plugin(autoIncrement.plugin, { model: 'ukadmincollections', field: 'adminID',startAt: 19, incrementBy: 1 });
...
var shareBookingmodul = mongoose.model('uksharebookingcollections', shareBookingSchema);
...
var localstoragemodul = mongoose.model('uklocalstoragecollections', localstorageSchema);
...
var geocodemodul = mongoose.model('ukgeocodecollections', geocodeSchema);
...
var incentiveCategorySchema = new mongoose.Schema({
  ...
  incentiveCategorySchema.plugin(autoIncrement.plugin, { model: 'ukcentivecategorycollections', field: 'enrtyID',startAt: 1, incrementBy: 1 });
  var incentiveCategorymodul = mongoose.model('ukcentivecategorycollections', incentiveCategorySchema);


///PlayStore App Virsion
var playstoreSchema = new mongoose.Schema({     
  appVersion:String, 
  appCategory:String,
  type:String
});

var playstoremodul = mongoose.model('ukplaystorecollections', playstoreSchema);
...
var schedulemodul = mongoose.model('ukschedulecollections', scheduleSchema);


module.exports.schedule=schedulemodul;
module.exports.playstore=playstoremodul;
