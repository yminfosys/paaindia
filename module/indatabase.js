...
///2dsphar indexing creat///////
  ...
  function index2Ddemand(int,cb){
    ...
    function index2DplaceSearch(int,cb){
        const db = mongojs('mongodb://127.0.0.1:27017/paacab', ['ingeocodecollections']);
        db.ingeocodecollections.createIndex({ "location" : "2dsphere" });
        cb({success:'1'})
      }   
...
var playstoremodul = mongoose.model('playstorecollections', playstoreSchema);
...
var schedulemodul = mongoose.model('inschedulecollections', scheduleSchema);
...
module.exports.index2DplaceSearch=index2DplaceSearch
