      ...
      $.post('/uk/existingPrerideCall',{pilotID:data.pilotID,driverBusy:data.driverBusy},function(rides){
        ...
        rides.forEach(function(val,indx,ar){
            ...
            if(val.callbookingStatus=="clineLocate"){
                ...
                <img style="height: 100%; width: 100%;" src="/uk/images/gif/circle1.gif">\
              ...
              <a onclick="callinit(\'' + val.CustID+ '\')"><button type="button" class="btn btn-warning btn-ms"><i class="fa fa-phone" aria-hidden="true"></i></button></a>\
    ...
    if(a==1){
        ...
        ((navigator.platform.indexOf("iPhone") != -1) || 
         ...
         (navigator.platform.indexOf("iPod") != -1)){
           ...
           //window.open("google.navigation:q="+lanlng[0]+","+lanlng[1]+"&amp;mode=d");
...
function clineLocated(indx,picklatlng){
    ...
    $.post('/uk/clinelocateDistance',{picklat:picuklatlng[0],picklng:picuklatlng[1]},function(respon){
...
function clineLocatedStart(indx){
    ...
    console.log("respon",respon)
        if(respon){                    
            ...
            $.post("/uk/CarLoogbookClineLocate",{bookingID:bookingID},function(data){console.log(data)});
        }
...
$.post('/uk/incentiveCalculation',{month:month},function(data){
if(data){
...
socket.on("preRidegotodemandpktsend",function(data){
    ...
    if(setSystem=="ONLINE"){    
        if(data.pilotID==getCookie("pilotID")){            
            $.post('/uk//admin/sub/preRidegotodemandpktRetun',{
                ...
                <div class="row">\
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">\
                        <div style="background-color:#facb3d; height: 65vh; text-align: center; " class="thumbnail">\
                            <img style="width: 30%; margin-top: 30px;" src="/uk/images/centerpin.png" alt="">\
                            <div  class="caption">\
...
function openMap(demandID,lat,lng,pilotID,subAdminID){
    ...
    //////Start Car LogBook Reding For PreRide//////
    $.post("/uk/gotodemandkmstart",{pilotID:pilotID,demandID:demandID,subAdminID:subAdminID,lat:lat,lng:lng},function(data){
...
function inLocation(pilotID,demandID,subAdminID){
    ...
    $.post("/uk/gotodemandkmsfinish",{pilotID:pilotID,demandID:demandID,subAdminID:subAdminID},function(data){
        console.log(data)
        if(data){
