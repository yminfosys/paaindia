...
function initMap() { 
    ...
    function wachLocation(){ 
      wachID= setInterval(function(){
        $.post('/uk/preRideGetDriverLocation',{},function(driverloc){
          if(driverloc){
  ...
  if(setSystem=="ONLINE"){    
    ...
    document.getElementById("toggle").addEventListener("click", function(){      
      if(document.getElementById("toggle").checked == true){ 
        ...
        $.post('/uk/offlinePermission',{},function(offper){
          if(offper){
            offlineExecute();
          }else{
 ...
 var socket = io('//'+document.location.hostname+':'+document.location.port);
  ...
  var socket = io('//'+document.location.hostname+':'+document.location.port);
    ...
    if(data.pilotID==getCookie("pilotID") && data.mode=="online"){
      ...
      function checkDocExpairy(){
        $.post('/uk/checkDocExpairy',{pilotID: getCookie("pilotID")},function(data){
          if(data=="Deactive"){
            alert("Your DriveinLicence Or Insurence are Expir")
        ...
        $.post('/uk/drv/dutyUpdate',{duty:'offline'},function(data){
          ...
          //dutyHours Count//////
            dutyHourCount("0",function(duty){
              if(duty){
                ////////Call CashCollection//////         
                window.location.href="../uk/preDriverCash?offline=exit";   
              }
            });
          }         
  ...
  function demandCallInitiate(pilotID){
    $.post('/uk/demandCallInitiate',{pilotID:pilotID,driverBusy:"busy",demandCall:"demandCall"},function(rides){ 
      if(rides){
...
setInterval(function(){
  ...
  $.post('/uk/dutyhoursControl',{timeHours:timeHours},function(data){
    if(data){
