      ...
      $.post('/uk/geoplace',{lat:latlng.lat,lng:latlng.lng},function(data){
        if(searchmod=='0'){
              /////Update LatLng Address for Geocod and Local Storage//////
                ...
                $.post('/uk/localstorageandgeocode',{lat:latlng.lat,lng:latlng.lng,pickupads:data.results[0].formatted_address,type:"pickup"},function(ddd){
          ...
          $.post('/uk/localstorageandgeocode',{lat:latlng.lat,lng:latlng.lng,dropads:data.results[0].formatted_address,type:"drop"},function(ddd){
...
function updateDemand(latlng){
 ...
 function cityLocation(latlng){
   if(getLocation==0){
     getLocation=1;
     $.post('/uk/updateCustomerCityName',{lat:latlng.lat, lng:latlng.lng},function(data){
       if(data){
 ...
 function ContinueNext(changeType){
  ...
  var deliveryPrice=$("#deliveryPrice").val();
    ...
    <div class="col-xs-2 col-sm-2 col-xs-offset-5 col-sm-offset-10 ">\
        <img id="expend" onclick="expendDetails(1)" style="width: 100%;" src="/uk/images/expend1Arrow.png">\
        <img id="dexpend" onclick="expendDetails(2)" style="width: 100%; display: none;" src="/uk/images/expendArrow.png">\
    </div>\
    <div class="col-xs-12 col-sm-12">\
        <div class="col-xs-3 col-sm-3">\
            <img style="width: 100%; border: 1px solid rgb(218, 9, 9);" class="img-circle" src="/uk/images/delideryMod'+ModeofDelivery+'.png">\
            <span style="font-size: xx-small; text-align: center; margin-left: 10%;">'+modofdel(Number(ModeofDelivery))+'</span>\
        </div>\
        <div class="col-xs-9 col-sm-9">\
            <div class="col-xs-4 col-sm-4">\
                <img id="deliveryType1" onclick="changeDelivertType(1)" style="width: 100%; border: 3px solid rgb(9, 218, 44); padding: 1px;" class="img-rounded" src="/uk/images/urgent.png">\
                <span style="font-size: 8px; text-align: center; margin-left: 10%;" >Urgent</span>\
            </div>\
            <div class="col-xs-4 col-sm-4">\
                <img id="deliveryType2" onclick="changeDelivertType(2)" style="width: 100%; border: 1px solid rgb(8, 8, 8); padding: 1px;" class="img-rounded" src="/uk/images/sameday.jpeg">\
                <span style="font-size:8px; text-align: center; margin-left: 10%;" >Same-Day</span>\
            </div>\
            <div class="col-xs-4 col-sm-4">\
                <img id="deliveryType3" onclick="changeDelivertType(3)" style="width: 100%; border: 1px solid rgb(5, 5, 5); padding: 1px;" class="img-rounded" src="/uk/images/nextDay.png">\
 ...
 function conframDelivery(){
  ...
  $.post('/uk/conframDelivery',{
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">\
        ...
        <p><img style="width: 100%; height: 20px;" src="/uk/images/gif/378.gif"></p>\
