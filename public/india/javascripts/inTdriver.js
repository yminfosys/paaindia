  ...
  if(a==1){
      ...
      ((navigator.platform.indexOf("iPhone") != -1) || 
       ...
       (navigator.platform.indexOf("iPod") != -1)){
        ...
        $.post("/india/tdrv/startCarLoogbook",{bookingID:bookingID},function(data){
          console.log(data)
         // alert(data)
        });
        $("#clineLocated").css({"display":"block"});
...
////////Finish Ride///////   
function finishride(){   
 // alert("Booking ID "+$("#bookingID").val()+"");
  ...
  $.post('/india/tdrv/ledger',{pilotID:pilotID},function(data){
    ...
    if(Number(data.driverCetegory)== 1){
      ...
      if(Number(data.previousDue)>=Number(data.previousEarning)){
        ...
        btnn='<form name="myForm" action="/india/tdrv/withdrawal" onsubmit="return validateForm()" method="POST" class="form-inline" role="form">\
             ...
             <ul class="list-group">\
                 <li class="list-group-item active ">\
                   ...
                   Total Cash Collection  <span>\
                      <button onclick="viewDailyLedgerInit('+data.pilot.pilotID+')" type="button" class="btn btn-info btn-xs">View Details</button>\
                      </span>\
                 </li>\
...
function viewDailyLedgerInit(pilotID){
  alert(pilotID)
}

function viewDailyLedger(pilotID){
  $.post('/india/tdrv/ledger',{pilotID:pilotID},function(data){
...
function incentive(){
  ...
  var incentiveCategory=$("#incentiveCategory").val();
  //alert(incentiveTravelMode)
    $.post('/india/admin/incentiveModule',{incetiveCity:incetiveCity,incentiveTravelMode:incentiveTravelMode,incentiveCategory:incentiveCategory},function(data){
        if(data.length >0){
