...
function connectSocket() {
    sockete = io.connect(baseURL, {
        query: {
            name: myName
        }
    });

    sockete.on('newCall', data => {
...
function sendICEcandidate(data) {
    ...
    sockete.emit("ICEcandidate", data)
}
...
function processCall(userName) {
    peerConnection.createOffer((sessionDescription) => {
        ...
        ringWeakupRequiest(userName);
    }, (error) => {
        console.log("Error");
    });
}
function ringWeakupRequiest(userID){
    $.post('/india/ringWeakupRequiest',{userID:userID},function(data){
        console.log(data);
...
function stop() {
    document.getElementById("dataCall").style.display = "none";
    stopRingtone();
...
function stopCall(userID){
    $.post('/india/stopwebcall',{CustID:userID, pilotID:'D'+$("#pilotID").val()+''},function(data){
        console.log(data);
