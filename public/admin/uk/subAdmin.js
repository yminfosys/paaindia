            ...
            cityList(function(city){
                ...
                <div class="row">\
                  <div   class="col-xs-5 col-sm-5 col-md-2 col-lg-2">\
                    <img style="height: 100px; width: 100px;" class="img-responsive img-circle" src="' + data.photo + '" onclick="window.open(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
                  </div>\
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">\
                              <div class="form-group">\
                                ...
                                <div class="form-group">\
                                    ...
                                    <option value="5">UK Delivery Boy</option>\
                                    </select>\
                                </div>\
                                <div class="form-group">\
                      ...
                      <div class="row">\
                        <div id="docm" style="margin-top: 10px;" class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-md-offset-1 col-lg-offset-1">\
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">\
                                <div class="thumbnail">\
                                <img  style="height: 200px; width: 100%;"  src="' + data.photo + '" onclick="zoompic(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
                                <div class="caption">\
                                    ...
                                    <form action="/uk/admin/sub/uploadfile" method="POST" enctype="multipart/form-data">\
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">\
                                <div class="thumbnail">\
                                <img style="height: 200px; width: 100%;"  src="' + data.Idproof + '" onclick="zoompic(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
                                <div class="caption">\
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">\
                                <div class="thumbnail">\
                                <img style="height: 200px; width: 100%;"  src="' + data.dl + '" onclick="zoompic(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
                                <div class="caption">\
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">\
                                <div class="thumbnail">\
                                <img style="height: 200px; width: 100%;"  src="' + data.rto + '" onclick="zoompic(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
                                <div class="caption">\
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">\
                                <div class="thumbnail">\
                                <img style="height: 200px; width: 100%;"  src="' + data.insurence + '" onclick="zoompic(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
                                <div class="caption">\
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">\
                                <div class="thumbnail">\
                                <img style="height: 200px; width: 100%;"  src="' + data.polution + '" onclick="zoompic(this.src)" onerror="if (this.src != \'error.jpg\') this.src = \'/uk/driverDocument/defult.png\';">\
                                <div class="caption">\
...
function findCustomer(mobile){
  ...
  $.post('/uk/admin/sub/findCustomer', { CustID: CustID }, function(data) {
    $("#content-2").css({"display":"none"});
        ...
        <div  class="tab-content">\
            <div role="tabpanel" class="tab-pane fade in active" id="profile">\
              <div style="background-color: rgb(253, 253, 253);" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">\
                  <div class="thumbnail">\
                    <button type="button" onclick="closeDriverFind()" class="btn btn-xs btn-danger">X</button>\
                      <img style="width: 50%;" class="img-responsive img-circle" src="/uk/images/custLogo.png" alt="">\
...
function resetCust() {
  ...
  $.post('/uk/admin/sub/resetCustomer', { custMobileNo: custMobileNo }, function(data) {
      alert(data)
      $("#content-1").html('');
  })
}
...
function specialCustDiscount() {
  ...
  if (Number(custspaicleDiscount) >= 0) {
      $.post('/uk/admin/sub/specialCustDiscount', { custMobileNo: custMobileNo, custspaicleDiscount: custspaicleDiscount }, function(data) {
          alert(data);
          $("#content-1").html('');
      })
  } else {
...
function setActiveCust() {
  var custMobileNo = $("#custMobileNo").val();
  $.post('/uk/admin/sub/setActiveCust', { custMobileNo: custMobileNo }, function(data) {
      alert(data);
      $("#content-1").html('');
  })
}
...
function setDeactiveCust() {
  var custMobileNo = $("#custMobileNo").val();
  $.post('/uk/admin/sub/setDeactiveCust', { custMobileNo: custMobileNo }, function(data) {
      alert(data);
      $("#content-1").html('');
  })
}
...
function verifyDriver() {
    ...
    $.post('/uk/admin/verifyDriver', { mobile: mobile, isd: isd ,dlExpDate:dlExpDate, insExpDate:insExpDate}, function(data) {
        if (data != 'worng') {
          findDriver();
            // //alert(data) 
...
function deactivate(){
  var mobile = $("#AccountID").val();
  var isd = '+44';
  $.post('/uk/admin/deactivate', { mobile: mobile, isd: isd }, function(data) {
    if (data != 'worng') {
      findDriver();
    }
  });
...
function submitEngintype() {
    ...
    $.post('/uk/admin/updateBasicDetails', {
        engintype: engintype,
        milege: milege,
        mobile: mobile,
        isd: isd,
...
function updateBankDetails() {
    ...
    $.post('/uk/admin/updateBankDetails', {
...
function updateDutyShedule() {
    ...
    $.post('/uk/admin/updateDutyShedule', { dutyStart: dutyStart, breakStart: breakStart, breakEnd: breakEnd, dutyEnd: dutyEnd, mobile: mobile, isd: isd }, function(data) {
...
function cancelDutyShedule() {
    ...
    $.post('/uk/admin/cancelDutyShedule', { mobile: mobile, isd: isd }, function(data) {
...
function offlinereqbyadmin(pilotID) {
    //alert(pilotID)
    $.post('/uk/admin/onofflinebyadmin', { pilotID: pilotID, mode: "offline" }, function(data) {
        alert(data);
...
function onlinereqbyadmin(pilotID) {
    $.post('/uk/admin/onofflinebyadmin', { pilotID: pilotID, mode: "online" }, function(data) {
        alert(data);
    });
}
...
function searchDriver() {
    ...
    $.post('/uk/admin/findDriver', { mobile: mobile, isd: isd }, function(data) {
        if (data != 'worng') {
            ...
            $("#page-head").html('<h1>' + data.name + '<small> Mobile: +44 ' + data.mobileNumber + ' ID: ' + data.pilotID + '</small></h1>')
...
function subdrivermonthlyhour() {
    ...
    // alert(pilotID)
    $.post('/uk/subMonthlyhours', { month: month, pilotID: pilotID }, function(data) {
...
function subcashcollection() {
    var pilotID = $("#pilotID").val();
    $.post('/uk/subdrivercashdue', { pilotID: pilotID }, function(data) {
...
function getOrderDetailsByAdmin() {
    ...
    $.post('/uk/admin/sub/getOrderDetailsbysubadmin', { cancelBookingID: cancelBookingID }, function(data) {
...
function cancelOrderByAdmin(cancelBookingID) {
    ...
    $.post('/uk/admin/sub/orderCancelByAdmin', { cancelBookingID: cancelBookingID }, function(data) {
        alert(data)
    })
}
...
function refreshDemand() {
    $.post('/uk/admin/sub/refreshdemand', {}, function(data) {
        alert(data)
    })
}
...
function activeDriver(page,noOfitem) {
  $("#content-2").css({"display":"none"});
    $.post('/uk/admin/activeDriverTotalItem', {}, function(data) {
  ...
  $("#activeDriverList").html('<img style="width: 25%; margin-top: 10%; margin-left: 35%;" src="/uk/images/gif/circle.gif" class="img-responsive img-circle" alt="Image">')
      var out='';
      ...
      $.post('/uk/admin/activeDriver', { skip: skip , limit:Number(noOfitem)}, function(driver) {
        if(driver.length > 0){
...
function dailyVerificationList(){
  var today=$("#toDay").val();
  $.post('/uk/admin/dailyVerification', {today:today}, function(data) {
    if(data.length > 0){
...
function totalCustomer() {
    $.post('/uk/admin/totalcust', {}, function(data) {
        if (data) {
            alert(data);
        }
    })
...
function dailyResolveCustInit(){
  ...
  function dailyResolveCustList(){
    var today=$("#toDay").val();
    $.post('/uk/admin/dailyCustResolve', {today:today}, function(data) {
      if(data.length > 0){
...
//     $.post('/uk/admin/cityList',{},function(data){
//         cb(data);
//     })
// }

function cityList(cb){
  $.post('/uk/admin/cityListDistinc',{},function(data){
      cb(data);
  })
}
...
function fulePriceList(){
  //alert("ok")
  $("#cityFuelPrice").html('<img style="width: 25%; margin-top: 10%; margin-left: 35%;" src="/uk/images/gif/circle.gif" class="img-responsive img-circle" alt="Image">')
  $.post('/uk/admin/getFuelPriceList',{},function(data){
...
function getNewDriveRegisterlist() {
  $("#newDriverRegList").html('<img style="width: 25%; margin-top: 10%; margin-left: 35%;" src="/uk/images/gif/circle.gif" class="img-responsive img-circle" alt="Image">');
  $.post('/uk/admin/sub/gatherNewDriver', {}, function(data) {
      if (data.length > 0) {
...
function getNewCustRegList(){
  $("#newCustList").html('<img style="width: 25%; margin-top: 10%; margin-left: 35%;" src="/uk/images/gif/circle.gif" class="img-responsive img-circle" alt="Image">');
  ////Total New Customer///////////////
  $.post('/uk/admin/totalNewCustomer', {}, function(data) {
    $("#newCustomerCount").html(data.item);
    $.post('/uk/admin/gatherNewCustomer', {}, function(cust) {
      if (cust.length > 0) {
        $("#newCustList").html('');
...
function custMarkasRead(id) {
  $.post('/uk/admin/updatefollowupStatus', { id: id }, function(data) {
      if (data) {
        getNewCustRegList();
      }
  })
  ...
  if(pilotID && today){
    ...
    <div  class="col-xs-12 col-sm-12 col-md-12col-lg-12 ">\
        <div class="panel panel-success">\
            ...
            <img style="width: 25%; margin-top: 10%; margin-left: 35%;" src="/uk/images/gif/circle.gif" class="img-responsive img-circle" alt="Image">\
            </ul>\
        </div>\
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">\
    ...
    $.post('/uk/admin/getBookingDemandDetails', {today:today,pilotID:pilotID}, function(data) {
      var totalBookAmt=0;
      var totaBooklKM=0;
      var fuelcost=0;
...
function driverReset(){
  ...
  $.post('/uk/admin/resetDriver', { pilotID: pilotID }, function(data) {
    if (data) {
      alert(data);
    }
})
...
function tDriverMonitor(){
  $.post('/uk/admin/sub/getTdriverMonitor', {}, function(data) {
    if(data.length > 0){
      $("#content-2").css({"display":"none"})
      $("#content-1").html('<div class="container">\
      <div class="panel panel-success">\
      ...
      data.forEach(function(val){
        $.post('/uk/admin/sub/getTdriverDetails', {pilotID:val.pilotID}, function(pilot) {
          console.log(pilot)
          ...
          <div style="height: 250px; overflow-y: auto;" class="thumbnail text-center">\
              ...
              <div class="caption">\
                  ...
                  <p><img style="width: 50px; height: 20px;" src="/uk/images/DriverMarker'+pilot.travelmod+'.png"><br>[ '+pilot.cityName+' ]</p>\
                  <p>\
...
function dropdriver(pilotID){
  $.post('/uk/admin/sub/monitorDriverDrop',{pilotID:pilotID},function(data){
    if(data=="success"){
      tDriverMonitor();
    }  
  })
  ...
  function dropAllDriver(){
    $.post('/uk/admin/sub/dropAlldriver',{pilotID:pilotID},function(data){
      if(data=="success"){
        tDriverMonitor();
      }  
    })
  ...
  function changeMobileNo(){
    ...
    if(oldmobile && newmobile){
      $.post('/uk/admin/sub/changeMobileNo',{oldmobile:oldmobile,newmobile:newmobile},function(data){
        alert(data)  ;
      })
    }else{
      alert("enter Value");
  ...
  function getCallMargeDetails(){
    ...
    $.post('/uk/admin/sub/CustCallMargeing',{ContNo:ContNo},function(data){
      if(data.status=="ok"){
  ...
  socket.on('chatisConnecting', function (data) {
    ...
    $.post('/uk/chatisConnectingSuccess',{CustID:data.CustID},function(incoming){
      if(incoming){
    ...
    <div style="margin-top: 5px;" class="panel panel-primary">\
          ...
          <div style="height: 34vh; overflow-y: auto;" class="panel-body">\
            ...
            <div class="col-xs-4 col-sm-4 col-xs-offset-4 col-sm-offset-4">\
                <img width="100%" src="/uk/images/gif/progress.gif">\
            </div>\
   ...
   function acceptbyAdmin(CustID){
     clearTimeout(chatincomming);
      $.post('/uk/chatisConnectingAccept',{CustID:CustID},function(accept){
        if(accept){
          $("#C"+CustID+"").remove();
          $("#chatSupport").append('<div id="chatWindow'+accept.ACCEPT_SESSION+'" style="float: right;"  class="col-xs-3 col-sm-3">\
          <div style="margin-top: 5px;" class="panel panel-primary">\
                <div class="panel-heading">\
                      <h3  class="panel-title"><img width="30px" src="/uk/images/custLogo.png"> Paa Cust ID:'+CustID+'\
  ...
  function sendChatContent(chatSession){
    ...
    $.post('/uk/sendChatContentAdmin',{chatSession:chatSession,chatContent:chatContent,userID:CustID},function(data){
      if(data){
  ...
  socket.on('chatSessionDisconnect', function (data) {
   ...
   function rejectIncomingChat(req,cb){
    ...
    $.post('/uk/chatisConnectingReject',{CustID:req.CustID},function(reject){
      if(reject){
        clearTimeout(chatincomming);
        cb("reject");
   ...
   function chatSessionDisconnect(sessionID){
    $.post('/uk/chatSessionDisconnect',{sessionID:sessionID},function(data){
      if(data){
   ...
   function ScheduleOrder(){
     var serchDate=$("#SearchDate").val();
      ...
      $.post('/uk/getScheduleOrder',{serchDate:serchDate},function(data){
        if(data.length >0 ){
          $("#content-2").css({"display":"none"});
          $("#content-1").html('<div class="container">\
          <div class="panel panel-success">\
    ...
    function getCustDetails(CustID,bookingID){
      $.post('/uk/getCustDetails',{CustID:CustID},function(cust){
        if(cust){
    ...
    function cancelOrder(bookingID){
      $.post('/uk/cancelScheduleOrder',{bookingID:bookingID},function(data){
        if(data){
          ScheduleOrder();
        }
      })
    ...
    function FinishUnFinishOrder(){
      ...
      if(bookingID.length >0){
        $.post('/uk/admin/sub/preRideFinishBySubadmin',{bookingID:bookingID},function(data){
          if(data){
